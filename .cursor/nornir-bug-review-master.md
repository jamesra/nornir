...
| C06-B008 | 06 | P2 | bug | `layout.py:321-332` | `MaxTensionMagnitude` sums over axis 1 of a 1-D `(2,)` vector → `AxisError`; the subsequent `argmax` on a scalar is meaningless | `np.sum(v ** 2, 1)` at 330 | fixed (`e4a047e`) | [#125](https://github.com/jamesra/nornir-review/issues/125) |
