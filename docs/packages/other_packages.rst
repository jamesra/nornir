...
* **nornir-pyre** — interactive registration and visualization (PyQt / OpenGL stack). Documented in its ``README.rst``; monodoc page to be added when the public API stabilizes.
